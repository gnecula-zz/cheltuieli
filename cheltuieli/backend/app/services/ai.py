...
PROVIDERS: dict[str, dict] = {
    ...
    "openrouter": {
        ...
        "models": [
            ("openrouter/free", "Auto gratuit (OpenRouter alege, inclusiv vedere)"),
            ("google/gemma-4-31b-it:free", "Gemma 4 31B (gratuit, vedere)"),
            ("google/gemma-4-26b-a4b-it:free", "Gemma 4 26B (gratuit, vedere)"),
            ("nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free", "Nemotron 3 Nano Omni (gratuit, vedere)"),
            ("thinkingmachines/inkling:free", "Inkling (gratuit, vedere)"),
            ("dots-studio/dots-3-note-preview:free", "Dots3-Note Preview (gratuit, vedere)"),
            ("nvidia/nemotron-3.5-lightning:free", "Nemotron 3.5 Lightning (gratuit)"),
            ("nvidia/nemotron-3-super-120b-a12b:free", "Nemotron 3 Super (gratuit)"),
            ("poolside/laguna-s-2.1:free", "Laguna S 2.1 (gratuit)"),
